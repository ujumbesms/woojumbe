...
/*
Plugin Name: WooJumbe
Description: UjumbeSMS Woocommerce plugin to send SMS Notification to customers and site administrators.
Version: 1.0
Author: UjumbeSMS
Author URI:http://www.ujumbesms.com/
*/

include('UjumbeSMS_Gateway.php');
...
class sms_class{
     ...
     */
	 public static function add_settings_tab( $settings_tabs ) {
        $settings_tabs['settings_tab_demo'] = __( 'UjumbeSMS Settings', 'SMS-Settings' );
    ...
    public static function get_settings() {
        $settings = array(
            'section_title' => array(
                'name'     => __( 'UjumbeSMS Setup', 'SMS-Settings' ),
                'type'     => 'title',
                'desc'     => 'Please fill in the fields below',
                'id'       => 'wc_SMS_Settings_section_title'
            ),
            'shop_name' => array(
                'name' => __( 'Shop Name', 'SMS-Settings' ),
                'type' => 'text',
                'desc' => __( 'Please indicate the name of your store', 'SMS-Settings' ),
                'id'   => 'shop_name',
                'default'   => get_option( "blogname" ,true)
            ),
            
            'username' => array(
                'name' => __( 'UjumbeSMS Email', 'SMS-Settings' ),
                'type' => 'text',
                'desc' => __( 'Provide your SMS Gateway username', 'SMS-Settings' ),
                'id'   => 'wc_SMS_Settings_username'
            ),
            'password' => array(
                'name' => __( 'UjumbeSMS API Key', 'SMS-Settings' ),
                'type' => 'text',
            ...
            'hints' => array(
                'name' => __( 'Please use the placeholder below in you message', 'SMS-Settings' ),
                'type' => 'title',
